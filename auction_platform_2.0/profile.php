  ...
  <div class="container">
    ...
    <div class="row mb-2">
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 box-shadow h-md-250">
            <div class="card-body d-flex flex-column align-items-start">
              <strong class="d-inline-block mb-2 text-primary">Auction Item #1052</strong>
              <h3 class="mb-0">
                <a class="text-dark" href="#">Ornate Mirror</a>
              </h3>
              <div class="mb-1 text-muted">Nov 12</div>
              <p class="card-text mb-auto">Views: 50</p>
        ...
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 box-shadow h-md-250">
            <div class="card-body d-flex flex-column align-items-start">
              <strong class="d-inline-block mb-2 text-success">Autcion Item #1051</strong>
              <h3 class="mb-0">
                <a class="text-dark" href="#">Hand Carved Marble Table</a>
              </h3>
              <div class="mb-1 text-muted">Nov 11</div>
              <p class="card-text mb-auto">Views: 20</p>
      ...
      <strong class="d-inline-block mb-2 text-primary">Activity</strong>
        ...
        <div class="media text-muted pt-3">
          <img data-src="holder.js/32x32?theme=thumb&amp;bg=007bff&amp;fg=007bff&amp;size=1" alt="32x32" class="mr-2 rounded" style="width: 32px; height: 32px;" src="data:image/svg+xml;charset=UTF-8,%3Csvg%20width%3D%2232%22%20height%3D%2232%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%2032%2032%22%20preserveAspectRatio%3D%22none%22%3E%3Cdefs%3E%3Cstyle%20type%3D%22text%2Fcss%22%3E%23holder_161b5ec71a0%20text%20%7B%20fill%3A%23007bff%3Bfont-weight%3Abold%3Bfont-family%3AArial%2C%20Helvetica%2C%20Open%20Sans%2C%20sans-serif%2C%20monospace%3Bfont-size%3A2pt%20%7D%20%3C%2Fstyle%3E%3C%2Fdefs%3E%3Cg%20id%3D%22holder_161b5ec71a0%22%3E%3Crect%20width%3D%2232%22%20height%3D%2232%22%20fill%3D%22%23007bff%22%3E%3C%2Frect%3E%3Cg%3E%3Ctext%20x%3D%2212.296875%22%20y%3D%2216.9%22%3E32x32%3C%2Ftext%3E%3C%2Fg%3E%3C%2Fg%3E%3C%2Fsvg%3E" data-holder-rendered="true">
...
<strong class="d-inline-block mb-2 text-primary">Recommended For You</strong>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                  ...
                  <b>
                Ornate Mirror</b><h3 class="mb-0">$200</h3><div class="mb-1 text-muted strike">$100</div></a>
                  <p class="card-text">Beautiful long mirror can stand elegantly in any dressing room.</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <small class="text-muted">Ending on 19/06/2018</small>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                  ...
                  <b>
                A Noble Lady of Venice</b><h3 class="mb-0">$600</h3><div class="mb-1 text-muted strike">$500</div></a>
                  <p class="card-text">Modern interpretation of Leighton's masterpiece.</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <small class="text-muted">Ending on 19/06/2018</small>
                  </div>
                </div>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                  ...
                  <b>
                The Thinker</b><h3 class="mb-0">$1,000</h3><div class="mb-1 text-muted strike">$900</div></a>
                  <p class="card-text">An adaption of Rodin's timeless masterpiece.</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <small class="text-muted">Ending on 19/06/2018</small>
                  </div>
                </div>
      ...
      <strong class="d-inline-block mb-2 text-primary">Active Auction</strong>
      ...
      <div class="row">
            ...
            <strong class="d-inline-block mb-2 text-primary">Auction History</strong>
